import { Inject, Injectable, type NestMiddleware, type Type } from '@nestjs/common';
import type {
  ArgumentsHost,
  ContextType,
  ExecutionContext,
...
const ExecutionContextMethodNotImplemented = new I18nError(
  "Method not implemented. @ifckit/i18n creates a fake Http context since it's using middleware to resolve your language. Nestjs middlewares don't have access to the ExecutionContext.",
);
