...
import { GeneralInternalServerException } from '@ifckit/exceptions';
import type { AbstractAccessCheckService } from '../services/access-check.service';
import type { PermissionCheckMode } from '../decorators/permission.decorator';
import type {
  IAccessTokenPayload,
